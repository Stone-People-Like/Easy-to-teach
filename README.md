...
- `《网页设计基础》（精简版）.md`：网页教程核心教学内容。
- `《Python程序设计基础》（精简版）.md`：Python 编程基础教程。
- `《数字媒体技术应用》（精简版）.md`：数字媒体技术相关教程。
- `《数据库基础》（精简版）.md`：数据库基础知识教程。
- `《网络技术基础》（精简版）.md`：计算机网络基础教程。
- `《计算机软硬件技术基础》（精简版）.md`：计算机软硬件基础教程。

### 📂 超级精简版
内容高度浓缩，表格化处理，适合考前快速查阅和背诵：
- `《Python程序设计基础》（精简版）.md`：Python 极致精简版教程。
